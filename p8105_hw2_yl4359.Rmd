...
There is `r nrow(wheel_data)` observations in wheel_data, 
`r nrow(precipitation_data)` observations in precipitation_data.
...
The year in resulting dataset is from `r min(pull(pols_snp_unemploy_data, year))` to `r max(pull(pols_snp_unemploy_data))`.
The key variables in the resulting dataset includes year, month, gov_gop, sen_gop, rep_gop, gov_dem, sen_dem, rep_dem, president, day, close and precentage.
